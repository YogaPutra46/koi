        ...
        <section>
            <div class="row">
                ...
                <div class="col-md-6 gx-5 mb-4 text-light">
                    <h4><strong>6 Jenis Ikan Koi: Varietas dan Warna (Beserta Gambarnya)</strong></h4>
                    <p>
                        Jika Anda memiliki kolam ikan koi di rumah, hal yang paling seru adalah mencari tahu ikan apa
                        yang akan dimasukkan ke dalamnya. Meski banyak orang tahu bahwa koi adalah ikan berwarna-warni
                        yang indah di dalam air, tidak banyak orang yang menyadari dengan tepat berapa banyak jenis koi
                        yang berbeda di luar sana!
                    </p>
                    <p>
                        Sebelum Anda mencari ikan koi baru, ada baiknya Anda mempelajari varietas dan warna koi agar tak
                        salah pilih. Dan berikut kami hadirkan 6 jenis ikan koi beserta gambarnya untuk Anda.
                    </p>
                </div>
            </div>
        </section>
